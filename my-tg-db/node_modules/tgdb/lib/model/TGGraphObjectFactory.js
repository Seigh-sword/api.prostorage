 ...
 * @constructor
 */
function TGGraphObjectFactory(entityMgr, graphMetadata) {
    // Since 1.1
    if (!graphMetadata) {
...
TGGraphObjectFactory.prototype.isEntity = function (entity) {
    return (entity instanceof TGAbstractEntity);
};
...
TGGraphObjectFactory.prototype.createUndirectedEdge = function(fromNode, toNode, edgeType) {
    return this.createEdge(fromNode, toNode, TGEdgeDirectionType.UNDIRECTED, edgeType);
};
...
TGGraphObjectFactory.prototype.createDirectedEdge = function(fromNode, toNode, edgeType) {
    return this.createEdge(fromNode, toNode, TGEdgeDirectionType.DIRECTED, edgeType);
};
