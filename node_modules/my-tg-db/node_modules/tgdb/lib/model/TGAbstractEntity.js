...
function TGAbstractEntity(graphMetadata, entityType) {
    ...
    var _entityType     = entityType; // TGEntityType base type of TGNodeType & TGEdgeType 
    var _version       = 0;
    var _isNew         = true;
    ...
    this.getAttributes = function() {
        ...
        return Object.keys(_attributes).filter(function(key){
        	// for 1.1
        	//x.getAttributeDescriptor().getName().compareToIgnoreCase("@name") != 0)
            return _attributes[key].getAttributeDescriptor().getName().toUpperCase()!=="@name".toUpperCase();
        }).map(function(key){
    ...
    // For 1.1
    this.setAttributeObject = function(attr, value) {
    ...
    this.readAttributes = function(inputStream) {
        ...
        if (entityTypeId !== 0) {
        	...
        	// For 1.1
            if (!_entityType)
            	_entityType = _graphMetadata.getEdgeType(entityTypeId);
